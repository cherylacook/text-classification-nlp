...
- DistilBERT notebook:
  ...
  - Tokenise with DistilBERT tokenizer
  - Fine-tune pretrained DistilBERT using HuggingFace Trainer, evaluate on test set
...
- Test accuracy improved consistently with increasing model complexity and using richer embeddings.
